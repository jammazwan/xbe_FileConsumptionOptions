...
### FileConsumptionOptions 

Functionality: **_Exploration - File consumption options - basic_**
...
Git clone the xbe_FileConsumptionOptions project into your workspace:

_from your bash shell:_

```bash
cd yourworkspacedirectory
git clone https://github.com/jammazwan/xbe_FileConsumptionOptions.git
cd xbe_FileConsumptionOptions
mvn install -DskipTests

```

You man now import xbe_FileConsumptionOptions into your IDE.
